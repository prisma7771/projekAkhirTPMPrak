...
// children: [
// Container(
// height: 50.0,child: Card(child: Text("${data.meals![0].strIngredient1}"))),
// ],
// ),
// Container(
// height: 50.0,child: Card(child: Text("${data.meals![0].strIngredient2}"))),
// Container(
// height: 50.0,child: Card(child: Text("${data.meals![0].strIngredient3}"))),
// Container(
// height: 50.0,child: Card(child: Text("${data.meals![0].strIngredient4}"))),
// Container(
// height: 50.0,child: Card(child: Text("${data.meals![0].strIngredient5}"))),
// Container(
// height: 50.0,child: Card(child: Text("${data.meals![0].strIngredient6}"))),
